...
// Mock Android headers for testing
#define ALOGI(fmt, ...) std::cout << "INFO: " << fmt << std::endl
#define ALOGW(fmt, ...) std::cout << "WARN: " << fmt << std::endl
#define ALOGE(fmt, ...) std::cerr << "ERROR: " << fmt << std::endl
#define ALOGV(fmt, ...) std::cout << "VERBOSE: " << fmt << std::endl
...
int jpeg_read_header(jpeg_decompress_struct* cinfo, int require_image) { return 1; }
int jpeg_start_decompress(jpeg_decompress_struct* cinfo) { return 1; }
int jpeg_read_scanlines(jpeg_decompress_struct* cinfo, unsigned char** scanlines, int max_lines) { return 1; }
int jpeg_finish_decompress(jpeg_decompress_struct* cinfo) { return 1; }
void jpeg_destroy_decompress(jpeg_decompress_struct* cinfo) {}

// Mock NDK Media types
typedef void* AMediaCodec;
typedef void* AMediaExtractor;
typedef void* AMediaFormat;
typedef int media_status_t;

// Mock NDK Media functions
AMediaCodec* AMediaCodec_createDecoderByType(const char* mime) { return nullptr; }
AMediaExtractor* AMediaExtractor_new() { return nullptr; }
AMediaFormat* AMediaFormat_new() { return nullptr; }
media_status_t AMediaExtractor_setDataSource(AMediaExtractor* extractor, const char* path) { return 0; }
media_status_t AMediaExtractor_getTrackFormat(AMediaExtractor* extractor, size_t index, AMediaFormat* format) { return 0; }
media_status_t AMediaCodec_configure(AMediaCodec* codec, const AMediaFormat* format, void* surface, void* crypto, uint32_t flags) { return 0; }
media_status_t AMediaCodec_start(AMediaCodec* codec) { return 0; }
media_status_t AMediaCodec_stop(AMediaCodec* codec) { return 0; }
media_status_t AMediaCodec_release(AMediaCodec* codec) { return 0; }
media_status_t AMediaExtractor_release(AMediaExtractor* extractor) { return 0; }
media_status_t AMediaFormat_delete(AMediaFormat* format) { return 0; }

// Mock SELinux functions
int setfilecon(const char* path, const char* context) { return 0; }
